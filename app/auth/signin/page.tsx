...
import { Heart, Eye, EyeOff, Mail, Lock, AlertCircle, CheckCircle } from 'lucide-react';
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-800">
                    <strong>HIPAA Compliant:</strong> Your health information is protected with enterprise-grade security.
                  </p>
                </div>
              </div>
            </div>
